...
fastq-dump -v --gzip --split-files SRR1554534
...
fastq-dump -v --gzip --split-files SRR2071345
...
fastq-dump -v --gzip --split-files SRR1554539
...
fastq-dump -v --gzip --split-files SRR2071350
